...
const defaultData = {
  ...
  characters: [
    ...
    },
    {
      ...
      speech: "",
      appearance:
        "평소 모습:\n19세 소녀. 키는 156cm 정도로 작고, 체구가 가늘어 쉽게 위축되어 보인다. 어깨를 자주 움츠리고 시선을 오래 마주치지 못한다.\n\n연한 금발에 가까운 밝은 머리카락을 어깨 아래까지 길렀고, 앞머리는 눈가를 살짝 가린다. 눈은 흐린 회색빛으로, 겁먹은 듯 자주 흔들린다.\n\n옷차림은 단정하지만 눈에 띄지 않는 편을 좋아한다. 소매가 긴 옷이나 큰 가디건을 자주 입어 몸을 숨기려는 인상이 강하다.\n\n해방 후 모습:\n해방 상태에서는 20대 중후반의 성숙한 여성 모습으로 변한다. 키가 커지고 체형은 길고 우아해지며, 평소의 위축된 분위기는 사라진다.\n\n머리카락은 허리까지 내려오는 밝은 금발로 길어지고, 눈은 깊은 붉은색으로 변한다. 표정은 여유롭고 도발적이며, 시선만으로도 상대를 압박한다.\n\n검은 그림자가 드레스처럼 몸을 감싸고, 발밑에는 사역마의 본체가 희미하게 따라붙는다. 아름답지만 인간 같지 않은 위험한 분위기를 풍긴다.\n\n사역마:\n사역마는 인간의 형체가 거의 없는 거대한 검은 괴물이다. 여러 개의 눈과 갈라진 입, 뼈처럼 마른 긴 팔을 가졌으며, 몸은 그림자와 진흙이 뒤섞인 것처럼 일렁인다.",
      background:
